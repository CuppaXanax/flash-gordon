...
struct fg_vk_context {
    ...
    fg_vk_kernel argmax,dense_subgroup,dense_cooked,dense_cooked_r8,dense_cooked_r8_ws,dense_cooked_r8_pair;
...
static void destroy_kernel(fg_vk_context *context,fg_vk_kernel *kernel){
    ...
    if(kernel==&context->dense_cooked){destroy_kernel(context,&context->dense_cooked_r8);destroy_kernel(context,&context->dense_cooked_r8_ws);destroy_kernel(context,&context->dense_cooked_r8_pair);}
...
fg_status fg_vk_open(fg_vk_context **out,fg_error *err){
    ...
    c->dense_cooked_r8_pair=(fg_vk_kernel){.file="fg_dense_q8_0_cooked_r8_pair.spv",.bindings=3,.push_bytes=20};
