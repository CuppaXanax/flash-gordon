...
fg_status fg_vk_end(fg_vk_context *c,fg_error *err){
    ...
    double wait_begin=vk_wall_seconds();
    ...
    vk_profile_add_wait(c,vk_wall_seconds()-wait_begin);
