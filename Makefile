...
tests/test_video: tests/test_video.o src/video.o src/tower.o vendor/stb_image_impl.o $(TEST_COMMON) | shaders
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)

test-video: tests/test_video
	./tests/test_video || test $$? -eq 77
