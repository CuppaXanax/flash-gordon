...
test: tests/test_core tests/test_session tests/test_chat tests/test_api
	./tests/test_core
	./tests/test_session
	./tests/test_chat
	./tests/test_api
...
clean:
	rm -f flash-gordon $(OBJ) $(DEP) tests/*.o tests/test_core tests/test_session tests/test_chat tests/test_api tests/test_fg_vk tests/test_hc_down_split tests/test_model_load tests/test_tokenizer tests/test_fabric vulkan/*.spv
