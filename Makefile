...
SRC := src/main.c vendor/stb_image_impl.c src/util.c src/tower.c src/tower_vk.c src/manifest.c src/session.c src/topology.c src/sha256.c src/gguf.c src/q38_schema.c src/q38_math.c src/quant.c src/vk.c src/model.c src/expert.c src/owner.c src/output.c src/tokenizer.c src/pack.c src/uring.c src/loader.c src/ngram.c src/qsa_state.c src/qsa_locality.c src/qsa_cache.c src/qsa.c src/qsa_owner.c src/qsa_replica.c src/protocol.c src/fabric.c src/prefix.c src/runtime_options.c src/sampler.c src/runtime.c src/chat.c src/api.c
OBJ := $(SRC:.c=.o)
