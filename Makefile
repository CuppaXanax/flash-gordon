...
OBJ := $(SRC:.c=.o)
DEP := $(OBJ:.o=.d) tests/test_core.d tests/test_session.d tests/test_prefix.d tests/test_chat.d tests/test_api.d tests/test_fg_vk.d tests/test_hc_down_split.d tests/test_model_load.d tests/test_tokenizer.d tests/test_fabric.d
...
test: tests/test_core tests/test_session tests/test_prefix tests/test_chat tests/test_api
	./tests/test_core
	./tests/test_session
	./tests/test_prefix
	./tests/test_chat
...
clean:
	rm -f flash-gordon $(OBJ) $(DEP) tests/*.o tests/test_core tests/test_session tests/test_prefix tests/test_chat tests/test_api tests/test_fg_vk tests/test_hc_down_split tests/test_model_load tests/test_tokenizer tests/test_fabric vulkan/*.spv
