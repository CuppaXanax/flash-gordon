...
#define FG_QSA_PREFILL_BATCH_QUERIES 4u
 ...
 * 640 MiB covers the complete record set of a two-layer rank at the full 262K
 * context (~618 MiB); a one-layer rank clamps to its complete ~309 MiB set.
...
fg_status fg_qsa_session_state_records_batch(fg_qsa_session *session,uint32_t layer,
